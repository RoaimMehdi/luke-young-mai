...
import { BookOpen, X, ZoomIn, ZoomOut, Check, ArrowRight, Shield, Share2 } from "lucide-react";
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-0 sm:p-4 md:p-6">
        ...
        >
          ...
          <div className="w-full h-1 bg-navy-mid">
            <div
          ...
          <header className="flex items-center justify-between px-4 sm:px-6 py-3.5 border-b border-border/80 bg-navy-deep/90 backdrop-blur-md shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="p-1.5 rounded bg-accent-blue/10 border border-accent-blue/30 text-accent-blue">
                <BookOpen className="h-4 w-4" />
              </div>
              <div>
                <h3 className="font-heading text-sm sm:text-base tracking-wider text-foreground uppercase">
                  Imagine The Following — Chapter One
                </h3>
                <p className="text-[10px] text-muted-foreground font-condensed tracking-widest uppercase hidden sm:block">
          ...
          <div
            ...
            className="flex-1 overflow-y-auto px-6 sm:px-12 md:px-20 py-10 bg-[#070E18] text-[#D4DEE8] selection:bg-accent-blue/30"
          >
            <div className="max-w-2xl mx-auto">
              {/* Cover Note & Heading */}
              <div className="border-b border-border/70 pb-8 mb-10 text-center">
                <span className="inline-block text-[11px] font-condensed font-bold tracking-[0.25em] text-accent-blue uppercase mb-3 px-3 py-1 bg-accent-blue/10 border border-accent-blue/30">
                  Free Unrestricted Access • 12 Min Read
                </span>
                <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl text-foreground tracking-wide mt-2">
                  CHAPTER 1: THE FOUNDATION &amp; CIVIC SOVEREIGNTY
                </h1>
                <p className="mt-3 text-xs sm:text-sm text-muted-foreground font-light max-w-lg mx-auto italic">
                ...
                <div className="mt-6 p-4 rounded bg-navy-mid/60 border border-blueprint/40 text-left">
              ...
              <article className={`space-y-6 ${fontClasses} font-serif tracking-normal text-[#D6E0EC]`}>
                <p className="first-letter:text-5xl first-letter:font-heading first-letter:text-accent-blue first-letter:float-left first-letter:mr-3 first-letter:leading-none">
                ...
                <div className="my-8 py-5 px-6 border-l-2 border-accent-blue bg-navy/60 font-sans text-sm italic text-cyan-glow">
                ...
                <h2 className="font-heading text-2xl sm:text-3xl text-foreground tracking-wide mt-10 pt-4 border-t border-border/40 font-sans">
              ...
              <div className="mt-12 p-6 sm:p-8 bg-navy/90 border border-electric/40 rounded-lg text-center font-sans">
                <Shield className="h-10 w-10 text-accent-blue mx-auto mb-3" />
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  <Link
                    to="/book"
                    onClick={onClose}
                    className="w-full sm:w-auto px-6 py-3 border border-blueprint/50 text-foreground text-xs font-semibold tracking-[0.12em] uppercase hover:bg-card transition-colors"
                  >
                    Order The Full Book
                  </Link>
                </div>
