...
export default function TopStatsBar() {
  ...
  return (
    <div className="w-full bg-[#03070D] border-b border-blueprint/30 text-foreground py-1.5 px-3 sm:px-6 relative z-50 overflow-hidden font-condensed tracking-wider text-xs">
      ...
      <div className="mx-auto max-w-7xl flex flex-wrap items-center justify-between gap-y-1.5 gap-x-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="hidden md:inline-block text-[11px] text-muted-foreground font-mono">
